...
from tomtrix.web_ui.utils import hide_st
...
hide_st( st )
st.write( "# Welcome to tomtrix 👋" )

html = """
<p align="center">
<img src = "https://user-images.githubusercontent.com/66209958/115183360-3fa4d500-a0f9-11eb-9c0f-c5ed03a9ae17.png" alt = "tomtrix logo"  width=120>
</p>
"""
...
with st.expander( "Features" ) :
    st.markdown(
        """
    tomtrix is the ultimate tool to automate custom telegram message forwarding.
    ...
    - If you are a python developer, writing plugins for tomtrix is like stealing candy from a baby. Plugins modify the message before they are sent to the destination chat.
