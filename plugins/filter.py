...
from tomtrix.plugin_models import TextFilter
from tomtrix.plugins import tomtrixMessage, tomtrixPlugin
from tomtrix.utils import match


class tomtrixFilter( tomtrixPlugin ) :
    id_ = "filter"
    ...
    def text_safe(self, tm: tomtrixMessage) -> bool :
    ...
    def users_safe(self, tm: tomtrixMessage) -> bool :
    ...
    def files_safe(self, tm: tomtrixMessage) -> bool :
