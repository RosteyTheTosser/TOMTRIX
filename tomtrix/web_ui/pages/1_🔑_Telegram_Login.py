    ...
    if check_password( st ) :
        ...
        if user_type == "Bot" :
            ...
            with st.expander( "How to get session string ?" ) :
                ...
                Link to repl: https://replit.com/@rosteythetosser/tg-login?v=1
                ...
                **Note from developer:**
                ...
                I have built a command-line program named tg-login (https://github.com/rosteythetosser/tg-login) that can generate the session string for you.
