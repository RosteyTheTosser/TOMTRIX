...
from tomtrix.plugin_models import STYLE_CODES

if TYPE_CHECKING :
    from tomtrix.plugins import tomtrixMessage


def platform_info() :
    nl = "\n"
    return f"""Running tomtrix {__version__}\
...
async def send_message(recipient: EntityLike, tm: "tomtrixMessage") -> Message :
